...
public class Vocabulary {
    ...
    public Vocabulary() throws ClassNotFoundException {
        sparkconf = new SparkConf().setAppName("Twoway Vocabulary");
    ...
    public static void main(String[] userargs) {
        try {
            System.out.println("\n\nSTART TWOWAY VOCABULARY\n\n");

            // region Arguments
            String[] args = new GenericOptionsParser(userargs).getRemainingArgs();
            if (args.length < 4) {
                System.err.println("Usage: Database.twoway.Vocabulary <path_to_dataset_1> <path_to_dataset_2> "
