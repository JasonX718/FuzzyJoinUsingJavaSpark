...
public class BFBH1MPar implements Serializable {
...
*/
	...
	public void closeSparkContext() {
		BFBH1MPar.javasparkcontext.close();
	}

	public BFBH1MPar() throws ClassNotFoundException {
...
//		System.out.println(pairRDD_0.groupByKey().filter(t->t._1.length()==CONST.LENGTH).count());
	...
	public static void main(String[] userargs) {
		try {
			...
			BFBH1MPar sparkProgram = new BFBH1MPar();
